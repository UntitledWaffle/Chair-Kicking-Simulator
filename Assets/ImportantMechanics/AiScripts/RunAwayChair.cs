...
public class RunAwayChair : MonoBehaviour
{
    ...
    public bool runAway = true; //Is it the goal of this AI to keep it's distance? If so, it needs to have runaway active.
    ...
    void AIFunctionality()
    {
        ...
        else if (TargetIsInSight())
        {
            ...
            { //make sure they do not get too close to the target
                //AHH! RUN AWAY!...  or possibly charge :smile:
